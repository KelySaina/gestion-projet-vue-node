<template>
  ...
  <div class="bg-gray-900 text-white p-6 w-[900px] h-[450px]">
    ...
    <div v-if="filteredTasks.length > 0" class="bg-gray-800 p-2 rounded-md shadow-lg h-[350px] min-h-[200px] overflow-y-auto">
      <div class="grid gap-4">
        <div v-for="task in filteredTasks" :key="task.id" class="p-4 bg-gray-700 rounded-md shadow-md">
